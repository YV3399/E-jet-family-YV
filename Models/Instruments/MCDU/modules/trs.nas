var TRSModule = {
    ...
    loadPageItems: func (n) {
        ...
        if (getprop('/position/gear-agl-ft') > 400) {
            append(me.views,
            ...
            me.controllers["L2"] = SelectController.new("TRS-MODE-SEL", "TO", 0);
            me.controllers["L3"] = SelectController.new("TRS-MODE-SEL", "CON", 0);
            me.controllers["L4"] = SelectController.new("TRS-MODE-SEL", "CLB", 0);
            me.controllers["L5"] = SelectController.new("TRS-MODE-SEL", "CRZ", 0);
        }
        if (getprop('/gear/gear[0]/wow')) {
            append(me.views,
                StaticView.new(12, 12, "TO DATA SET" ~ right_triangle, mcdu_white | mcdu_large));
            me.controllers["R6"] = SubmodeController.new("TO-DATASET", 0);
        }
    },
};
